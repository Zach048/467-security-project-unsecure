...
INSERT INTO `customer` (`id`, `first_name`, `last_name`, `email`, `phone`, `password`, `username`) VALUES (1, 'Cristobal', 'Goyette', 'ullrich.mallory@example.net', '1-234-141-3', SHA1('apple'), 'lucy');
INSERT INTO `customer` (`id`, `first_name`, `last_name`, `email`, `phone`, `password`, `username`) VALUES (2, 'Rachelle', 'Kessler', 'hfeeney@example.net', '+60(3)61285', SHA1('banana'), 'ykiehn');
INSERT INTO `customer` (`id`, `first_name`, `last_name`, `email`, `phone`, `password`, `username`) VALUES (3, 'Gilbert', 'Casper', 'macy.bruen@example.org', '+03(0)61135', SHA1('yellow'), 'pgottlieb');
INSERT INTO `customer` (`id`, `first_name`, `last_name`, `email`, `phone`, `password`, `username`) VALUES (4, 'Florencio', 'Kuhlman', 'haley.d\'amore@example.com', '793-834-504', SHA1('blue'), 'hazle.kshlerin');
INSERT INTO `customer` (`id`, `first_name`, `last_name`, `email`, `phone`, `password`, `username`) VALUES (5, 'Cali', 'Batz', 'fmitchell@example.org', '(876)745-31', SHA1('green'), 'bo29');
INSERT INTO `customer` (`id`, `first_name`, `last_name`, `email`, `phone`, `password`, `username`) VALUES (6, 'Brook', 'Kuvalis', 'ellen64@example.net', '+93(8)55223', SHA1('brown'), 'roderick.connelly');
INSERT INTO `customer` (`id`, `first_name`, `last_name`, `email`, `phone`, `password`, `username`) VALUES (7, 'Antwon', 'Kiehn', 'juvenal.waters@example.org', '1-476-534-3', SHA1('black'), 'llemke');
INSERT INTO `customer` (`id`, `first_name`, `last_name`, `email`, `phone`, `password`, `username`) VALUES (8, 'Vivien', 'VonRueden', 'lucienne.torp@example.org', '(842)847-58', SHA1('open'), 'vsenger');
INSERT INTO `customer` (`id`, `first_name`, `last_name`, `email`, `phone`, `password`, `username`) VALUES (9, 'Bria', 'Turner', 'ewell22@example.org', '+25(0)39634', SHA1('close'), 'orval.mills');
INSERT INTO `customer` (`id`, `first_name`, `last_name`, `email`, `phone`, `password`, `username`) VALUES (10, 'Emely', 'Bradtke', 'turner.mireille@example.com', '(240)012-43', SHA1('pop'), 'dexter.krajcik');
INSERT INTO `customer` (`id`, `first_name`, `last_name`, `email`, `phone`, `password`, `username`) VALUES (11, 'Maxwell', 'Nader', 'payton32@example.org', '(731)804-11', SHA1('window'), 'cole.reichert');
INSERT INTO `customer` (`id`, `first_name`, `last_name`, `email`, `phone`, `password`, `username`) VALUES (12, 'Deshaun', 'Hills', 'anabel.willms@example.com', '00202439340', SHA1('computer'), 'ismith');
INSERT INTO `customer` (`id`, `first_name`, `last_name`, `email`, `phone`, `password`, `username`) VALUES (13, 'Arjun', 'Hahn', 'blanda.ulises@example.org', '(906)106-92', SHA1('laptop'), 'lkovacek');
INSERT INTO `customer` (`id`, `first_name`, `last_name`, `email`, `phone`, `password`, `username`) VALUES (14, 'Enrique', 'Lang', 'kevon98@example.net', '286-925-839', SHA1('street'), 'moen.kailee');
INSERT INTO `customer` (`id`, `first_name`, `last_name`, `email`, `phone`, `password`, `username`) VALUES (15, 'Wilburn', 'Franecki', 'hyatt.noemie@example.com', '662.358.683', SHA1('sign'), 'fwindler');
INSERT INTO `customer` (`id`, `first_name`, `last_name`, `email`, `phone`, `password`, `username`) VALUES (16, 'Curtis', 'Powlowski', 'barton.kira@example.com', '299.097.700', SHA1('now'), 'abernathy.merle');
INSERT INTO `customer` (`id`, `first_name`, `last_name`, `email`, `phone`, `password`, `username`) VALUES (17, 'Ray', 'Rutherford', 'ruthe84@example.net', '483-971-735', SHA1('pword'), 'd\'amore.jadon');
INSERT INTO `customer` (`id`, `first_name`, `last_name`, `email`, `phone`, `password`, `username`) VALUES (18, 'Jennyfer', 'Mitchell', 'colleen05@example.com', '396.623.387', SHA1('password'), 'emilia.mosciski');
INSERT INTO `customer` (`id`, `first_name`, `last_name`, `email`, `phone`, `password`, `username`) VALUES (19, 'Jed', 'Mohr', 'tania58@example.com', '1-891-515-6', SHA1('chocolate'), 'beatty.coby');
INSERT INTO `customer` (`id`, `first_name`, `last_name`, `email`, `phone`, `password`, `username`) VALUES (20, 'Wilbert', 'Crona', 'xkshlerin@example.net', '476-007-657', SHA1('vanilla'), 'koch.camron');
INSERT INTO `customer` (`id`, `first_name`, `last_name`, `email`, `phone`, `password`, `username`) VALUES (21, 'Greta', 'Pagac', 'ruthie54@example.org', '893-332-845', SHA1('mint'), 'nbernhard');
INSERT INTO `customer` (`id`, `first_name`, `last_name`, `email`, `phone`, `password`, `username`) VALUES (22, 'Ethelyn', 'Kunze', 'haley.esperanza@example.net', '04654134880', SHA1('bag'), 'cathrine41');
INSERT INTO `customer` (`id`, `first_name`, `last_name`, `email`, `phone`, `password`, `username`) VALUES (23, 'Magdalena', 'Okuneva', 'ahand@example.org', '08289344167', SHA1('back'), 'hertha81');
INSERT INTO `customer` (`id`, `first_name`, `last_name`, `email`, `phone`, `password`, `username`) VALUES (24, 'Jarrett', 'Crona', 'yrempel@example.org', '1-945-369-1', SHA1('front'), 'erenner');
INSERT INTO `customer` (`id`, `first_name`, `last_name`, `email`, `phone`, `password`, `username`) VALUES (25, 'Shemar', 'Turner', 'anderson61@example.org', '369.900.567', SHA1('down'), 'tyrese68');
